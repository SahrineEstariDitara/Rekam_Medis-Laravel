                ...
                <form action="{{ route('staff.pasien.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="text-muted">
                                Digunakan untuk login pasien. Password default:
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('alamat') is-invalid @enderror"
                                  ...
                                  rows="3"
                                  required
                                  placeholder="Alamat lengkap domisili pasien">{{ old('alamat') }}</textarea>
